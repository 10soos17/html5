...
<body>
	...
	<br>작성일 :
	<fmt:formatDate value="${content.boardVo.board_writedate}"
		pattern="yyyy년 MM월 dd일 hh시 mm분 ss초" />
	조회수: ${content.boardVo.board_readcount}
	<br>
	...
	<form action="./changeRecommend.do" method="post">
		<input type="hidden" name="board_no"
			...
			name="member_no" value="${sessionUser.member_no}">
		<c:choose>
	...
	<c:if
		...
		<a
			href="./deleteContentProcess.do?board_no=${content.boardVo.board_no}">삭제</a>
