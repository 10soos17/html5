		...
		<section id="main">
			...
			<!-- 글쓰기 폼 -->
				...
				<table>
					...
					<tr id="subject">
						<td class="col1">제목</td>
						<td class="col2"><input name="board_title" type="text" value="${content.freeboardVo.board_title}"></td>
					</tr>
					<tr id="content">
						<td class="col1">내용</td>
						<td class="col2" ><textarea name="board_content">${content.freeboardVo.freeboard_content}</textarea></td>
					</tr>
					<tr id="upload">
