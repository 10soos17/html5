...
//=============btn_top, bottom====================================================
animateScrollTo = function(_selector, thisY, _duration, _adjust) {

     // - Get current &amp; target positions
    const scrollEle = document.getElementById("wrap");//document.documentElement || window.scrollingElement,
    currentY = scrollEle.scrollTop;

    console.log("_selector___:",_selector);
    ...
    function animateScrollTo(_startY, _endY, _duration){
        ...
        console.log("_duration:",_duration,"unitY:",unitY,
...
$("#search_text").on("input.highlight", function () {
    // Determine specified search term
    var searchTerm = $(this).val();

    // Highlight search term inside a specific context
    let res = $("#article").unmark().mark(searchTerm,
        {
            "acrossElements": true,
            "separateWordSearch": false,
        }
